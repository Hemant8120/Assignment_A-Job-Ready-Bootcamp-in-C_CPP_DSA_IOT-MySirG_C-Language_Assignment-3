...
//  Assignment-03_Problem-03: Write a program to check whether a given number is an even number or an odd number.
...
int main()
{
    // PROGRAM OPENING...
    system("cls");
    printf("This is Assignment-03_Problem-03: Will Check & Print, Whether The Given Number Is \"Even Or Odd\", Using A Bitwise Operator, On The Screen...");
